  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="glass-card rounded-xl p-6 text-center space-y-4 animate-slide-up">
        <h3 className="text-lg font-semibold text-foreground">Avalie a Goldblad no Google</h3>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg bg-primary text-primary-foreground font-semibold transition-all duration-300 hover:scale-[1.02] hover:opacity-90"
        >
